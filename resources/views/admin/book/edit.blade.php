            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="px-4 py-8 sm:px-0">
                    <div class="px-4 sm:px-6 lg:px-8">
                        <form action="{{ route('books.update', $book->id) }}" method="POST" class="space-y-8 divide-y divide-gray-200">
                                ...
                                <div>
                                    ...
                                    <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                                            ...
                                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                <div class="max-w-lg flex rounded-md shadow-sm">
                                                    <span
                                                        ...
                                                        book name/ </span>
                                                    <input type="text" name="title" id="title" value="{{$book->title}}" autocomplete="title"
                                        ...
                                        <div
                                            ...
                                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                <div class="max-w-lg flex rounded-md shadow-sm">
                                                    <input type="text" name="isbn" value="{{$book->isbn}}" id="isbn" autocomplete="isbn"
                                                        class="flex-1 block w-full focus:ring-indigo-500 focus:border-indigo-500 min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                <div class="max-w-lg flex rounded-md shadow-sm">
                                                    <input type="number" name="no_of_copies" value="{{ $book->no_of_copies}}" id="no_of_copies"
                                                        autocomplete="isbn"
                                                        class="flex-1 block w-full focus:ring-indigo-500 focus:border-indigo-500 min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300">
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                <div class="max-w-lg flex rounded-md shadow-sm">
                                                    <input type="number" name="no_of_pages" value="{{$book->no_of_pages}}" id="no_of_pages"
                                                        autocomplete="isbn"
                                                        class="flex-1 block w-full focus:ring-indigo-500 focus:border-indigo-500 min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300">
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                <div class="max-w-lg flex rounded-md shadow-sm">
                                                    <input type="text" value="{{$book->price}}" name="price" id="price" autocomplete="price"
                                                        class="flex-1 block w-full focus:ring-indigo-500 focus:border-indigo-500 min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300">
                                                </div>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                                <div class="max-w-lg flex rounded-md shadow-sm">
                                                    <input type="text"  value="{{$book->language}}" name="language" id="language"
